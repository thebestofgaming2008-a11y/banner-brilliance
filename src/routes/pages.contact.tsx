            ...
            <div className="mt-7 space-y-5">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[13px] text-black/55">support@fawzaan.com</p>
                </div>
              </div>
              <div className="flex gap-3">
                <MessageCircle size={19} />
                <div>
                  <p className="text-[12px] font-semibold">Response time</p>
                  <p className="mt-1 text-[13px] text-black/55">Within 1-2 business days</p>
                </div>
              </div>
            </div>
          </aside>
            ...
            {sent ? (
              <div className="border border-black/10 p-8">
                ...
                <p className="mt-4 text-[14px] text-black/60">
                  This frontend form is ready to connect to the support backend.
                </p>
                <button
                  type="button"
              ...
              >
                ...
                <label className="text-[11px] font-bold uppercase">
                  ...
                  <input className="mt-2 h-12 w-full border border-black/20 px-3 text-[14px] font-normal outline-none focus:border-black" />
                </label>
                <label className="text-[11px] font-bold uppercase">
                  Message
                  <textarea
